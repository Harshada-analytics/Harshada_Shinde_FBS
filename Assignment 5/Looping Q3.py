#Q3. Accept no. of passengers from user and per ticket cost. Then accept age of each passenger and 
# then calculate total amount to ticket to travel for all of them based on following condition :
#  a. Children below 12 = 30% discount 
#  b. Senior citizen (above 59) = 50% discount 
#  c. Others need to pay full.

passangers = int(input("Enter numbers of passangers:"))
ticket_cost = float(input("Enter550 ticket cost:"))

total_amount = 0

for i in range(1, passangers + 1):
